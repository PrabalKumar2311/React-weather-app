...
import { formatDate, formatTemprature } from '../utils/weatherutils';
  ...
  return (
    ...
    shadow-2xl'>
      <div className='flex items-center space-x-2 mb-8'>
        ...
        <Calendar className='w-7 h-6 text-white/80'/>
        </div>
      ...
      <div className='space-y-6.5'>
        ...
        {dailyItems.map((item, index)=> {
          ...
          return (
            <div key={index}className='flex items-center justify-between p-5 bg-white/5 backdrop-blur-sm
            ...
            <div className='flex items-center space-x-2 text-white/60'>
              ...
              <div className='text-right'>
                <div className='text-white font-bold text-xl'>
                  {formatTemprature(item.main.temp_max, unit)}°
                  </div>
                <div className='text-white font-bold text-xl'>
                  {formatTemprature(item.main.temp_min, unit)}°
                  </div>
              </div>
            </div>
          </div>
